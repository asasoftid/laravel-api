...
return [
	...
	*/
	...
	'web' => env('CLOCKWORK_WEB', '__clockwork'),
	...
	*/
	...
	// Compress the metadata files using gzip, trading a bit of performance for lower disk usage
	'storage_files_compress' => env('CLOCKWORK_STORAGE_FILES_COMPRESS', false),

	// SQL database to use, can be a name of database configured in database.php or a path to a SQLite file
	'storage_sql_database' => env('CLOCKWORK_STORAGE_SQL_DATABASE', 'log'),
